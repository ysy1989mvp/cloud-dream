			...
			<view class="part_2">
				<view class="juzhong">
					<view class="part_21 part_2_ct">
						...
						<text class="tab22">朋友圈推广</text>
					</view>
					<view class="part_22 part_2_ct">
						<text class="text_b tab21">任务内容:</text>
						<text class="tab22">
							1.接任务的账号，必须为自己真实的抖音账号有名字和头像。<br/>
							2.接任务账号需要至少1个自己的作品。<br/>
							3.接任务账号需有少量粉丝以及点赞。
						</text>
					</view>
					...
					<view class="part_24 part_2_ct">
						...
						<text class="tab22">http://taskdo.baijinglv.top/a</text>
					</view>
					<view class="part_25 part_2_ct">
						<text class="text_b tab21">任务图片:</text>
						<view class="tab22 teshu">
							<view class="img_img"><image class="img" src="../../../static/image/yangsongyan/task-detail/01.png"></image></view>
							<view class="img_img"><image class="img" src="../../../static/image/yangsongyan/task-detail/02.png"></image></view>
							<view class="img_img"><image class="img" src="../../../static/image/yangsongyan/task-detail/03.png"></image></view>
							<view class="img_img"><image class="img" src="../../../static/image/yangsongyan/task-detail/04.png"></image></view>
						</view>
					</view>
				</view>
			</view>
